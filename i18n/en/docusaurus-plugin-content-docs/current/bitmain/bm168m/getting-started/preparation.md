...
BM168M Powered by Type-C connector, supports 20V / 65W / 3.25A power input.
...
Serial port driver is required under WIndows:[Installation of Serial Driver](/bitmain/bm168m/getting-started/serial-driver-install.md)
