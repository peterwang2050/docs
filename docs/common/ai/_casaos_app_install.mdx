...
- 填入 radxa stable diffusion 容器安装所需信息
 ...
 <img src="/img/general-tutorial/tpu_ai/casaos_sd_0.1.0.webp" alt="radxa stable diffusion CasaOS Install" width="580px" />
...
**安装 chatdoc 前必须参考[内存分布修改工具](../local-ai-deploy/memory_allocate) 修改 SG2300X 内存分配**
